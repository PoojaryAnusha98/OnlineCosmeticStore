				...
				<form:form method="post" action="${url}" modelAttribute="productFormObj" enctype="multipart/form-data">
					<div class="col-sm-12">
						...
						<form:label path="productCategory">Product Category</form:label>
								 <form:radiobutton path="productCategory" value="Cosmetic"/>Cosmetic
								 <form:radiobutton path="productCategory" value="Skincare"/>Skincare
								 <form:radiobutton path="productCategory" value="Haircare"/>Haircare
								 <form:radiobutton path="productCategory" value="Fragrance"/>Fragrance
						</div>
						<div class="row">
