		...
		<table class="table table-hover" id="productList">
			<thead>
				<tr>
					...
					/Add to Cart
					</security:authorize> <!--views only to the admin --> <security:authorize access="hasAnyRole('ROLE_ADMIN')">
					/Edit/Delete
					</security:authorize>
					</th>
				</tr>
				...
				<c:forEach items="${products}" var="prod">
					<tr>
						<td style="width: 171px"><img
							src="<c:url value="images/products/${prod.productId}.jpg"/>"
						...
						<td ng-controller="myController"><a
							href="getProductById/${prod.productId}" class="btn btn-info d-inline p-2  text-white"
							...
							<!-- view only for user --> <security:authorize
								...
								<a href="#" ng-click="addToCart(${prod.productId})"
									class="btn btn-primary d-inline p-2 text-white" style="margin-left: 5px"> <span
								...
								<a href="admin/delete/${prod.productId}" class="btn btn-danger d-inline p-2  text-white"
