			...
			<div id="myCarousel" class="carousel slide" data-ride="carousel">
				...
				<div class="carousel-inner" role="listbox">
					<div class="item active">
						<img src="<c:url value="images/img1.jpg"/>" alt="Image1"
							width="460" height="345">
					</div>

					<div class="item">
						<img src="<c:url value="images/img2.jpg"/>"
							alt="Image2" width="460" height="345">
					</div>

					<div class="item">
						<img src="<c:url value="images/img3.jpg"/>"
							alt="Image3" width="460" height="345">
					</div>

					<div class="item">
						<img src="<c:url value="images/img4.jpg"/>"
