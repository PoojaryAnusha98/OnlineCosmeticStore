...
<html>
    ...
    <body>
        ...
        <c:set var="String" value="Welcome Anusha!!!"/>  
        <p>1)Find Anusha in string = Welcome Anusha!!! using Function tag<p>
            <c:if test="${fn:containsIgnoreCase(String, 'Anusha')}">  
            <p>Found Anusha in string<p>  
            </c:if>
